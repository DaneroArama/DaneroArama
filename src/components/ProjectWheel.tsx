    ...
    <>
      ...
      {isMobile && (
        <div className="flex flex-col gap-6">
          {/* Top Container - Glass Card with Background Image */}
          <div ref={containerRef} className="relative w-full rounded-2xl overflow-hidden min-h-[280px]">
            ...
            <div className="relative z-10 h-full bg-white/5 backdrop-blur-xl border border-white/10 p-6 space-y-2">
              {/* Project Name & Period */}
              <div className="flex items-start justify-between">
                ...
                {selectedProject.link && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-1.5 bg-transparent backdrop-blur-md border border-white rounded-full text-white transition-all duration-300 hover:scale-105"
                  >
